...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dhga_ema_decay", type=float, default=0.9995)
    parser.add_argument("--dhga_ema_warmup_steps", type=int, default=600)
    ...
    parser.add_argument("--dhga_text_layer_candidate_max_ratio", type=float, default=0.05)
    parser.add_argument("--dhga_text_layer_candidate_alpha", type=float, default=0.0)
    ...
    parser.add_argument("--dhga_text_layer_candidate_weight", type=float, default=0.0)
